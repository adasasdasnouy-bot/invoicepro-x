...
export class Backend implements backendInterface {
    ...
    async calcPos(arg0: bigint): Promise<PosResult> {
        if (this.processError) {
            try {
                const result = await this.actor.calcPos(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async calcProfit(arg0: bigint, arg1: bigint): Promise<ProfitResult> {
        if (this.processError) {
            try {
                const result = await this.actor.calcProfit(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createInvoice(arg0: string, arg1: bigint, arg2: bigint): Promise<Invoice> {
        if (this.processError) {
            try {
